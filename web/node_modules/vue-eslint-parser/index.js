...
function parseForESLint(code, parserOptions) {
    ...
    if (!isVueFile(code, options)) {
        result = parseScript(code, Object.assign(Object.assign({}, options), { ecmaVersion: options.ecmaVersion || DEFAULT_ECMA_VERSION, parser: getScriptParser(options.parser, () => {
                const ext = (path.extname(options.filePath || "unknown.js")
                    .toLowerCase() || "")
                    .slice(1);
                if (/^[jt]sx$/u.test(ext)) {
        ...
        if (skipParsingScript || !scripts.length) {
            result = parseScript("", Object.assign(Object.assign({}, options), { ecmaVersion: options.ecmaVersion || DEFAULT_ECMA_VERSION, parser: scriptParser }));
        }
