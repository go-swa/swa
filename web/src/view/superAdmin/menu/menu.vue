  ...
  <div>
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <el-button icon="plus" type="primary" @click="addMenu('0')">新增根菜单</el-button>
      </div>

      <el-table :data="tableData" row-key="ID">
        <el-table-column align="left" label="ID" min-width="100" prop="ID"/>
        <el-table-column align="left" label="展示名称" min-width="120" prop="roleName">
          <template #default="scope">
            <span>{{ scope.row.meta.title }}</span>
          </template>
        </el-table-column>
        <el-table-column align="left" label="图标" min-width="140" prop="roleName">
          <template #default="scope">
        ...
        <el-table-column align="left" label="路由Name" min-width="160" prop="name" show-overflow-tooltip/>
        <el-table-column align="left" label="路由Path" min-width="160" prop="path" show-overflow-tooltip/>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="handleClose" :title="dialogTitle">
      ...
      >
        ...
        <el-form-item prop="meta.activeName" style="width:30%">
          <template #label>
            <div>
              <span> 高亮菜单 </span>
              <el-tooltip content="注：当到达此路由时候，指定左侧菜单指定name会处于活跃状态（亮起），可为空，为空则为本路由Name。" effect="light" placement="top">
                <el-icon>
                  <QuestionFilled/>
                </el-icon>
              </el-tooltip>
        ...
        <el-form-item label="KeepAlive" prop="meta.keepAlive" style="width:30%">
          <el-select v-model="form.meta.keepAlive" placeholder="是否keepAlive缓存页面" style="width:100%">
            <el-option :value="false" label="否"/>
            <el-option :value="true" label="是"/>
          </el-select>
        </el-form-item>
        <el-form-item label="CloseTab" prop="meta.closeTab" style="width:30%">
          <el-select v-model="form.meta.closeTab" placeholder="是否自动关闭tab" style="width:100%">
            <el-option :value="false" label="否"/>
            <el-option :value="true" label="是"/>
          </el-select>
        </el-form-item>
        <el-form-item style="width:30%">
          <template #label>
            <div>
              <span> 是否为基础页面 </span>
              <el-tooltip content="此项选择为是，则不会展示左侧菜单以及顶部信息。" effect="light" placement="top">
                <el-icon>
                  <QuestionFilled/>
                </el-icon>
              </el-tooltip>
          ...
          <el-select v-model="form.meta.defaultMenu" placeholder="是否为基础页面" style="width:100%">
            <el-option :value="false" label="否"/>
            <el-option :value="true" label="是"/>
          </el-select>
        </el-form-item>
      ...
      <div>
        ...
        <el-table :data="form.parameters" style="width: 100%;margin-top: 12px;">
          <el-table-column align="left" label="参数类型" prop="type" width="180">
            <template #default="scope">
          ...
          <el-table-column align="left" label="参数key" prop="key" width="180">
            <template #default="scope">
              <div>
          ...
          <el-table-column align="left" label="参数值" prop="value">
            <template #default="scope">
              <div>
        ...
        <el-table :data="form.menuBtn" style="width: 100%;margin-top: 12px;">
          <el-table-column align="left" label="按钮名称" prop="name" width="180">
            <template #default="scope">
              <div>
          ...
          <el-table-column align="left" label="备注" prop="name" width="180">
            <template #default="scope">
              <div>
...
import {canRemoveRoleBtnApi} from '@/api/roleBtn'
...
const deleteBtn = async (btns, index) => {
  ...
  const res = await canRemoveRoleBtnApi({id: btn.ID})
  if (res.code === 0) {
    btns.splice(index, 1)
  }
}
