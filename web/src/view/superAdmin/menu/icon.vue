<template>
  <div>
    ...
    <el-select v-model="metaData.icon" class="gva-select" clearable filterable placeholder="请选择" style="width:100%">
      <el-option
      ...
      >
        <span :class="item.label" class="gva-icon" style=" padding: 3px 0 0; ">
          <el-icon>
